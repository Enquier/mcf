...
export class ApiClient {
  constructor(basePath, authentications) {
    /**
  ...
  /**
    ...
    */
  applyAuthToRequest(request, authNames, userAuth) {
    authNames.forEach((authName) => {
      ...
      switch (auth.type) {
        ...
        case 'apiKey':
          ...
          break;
        case 'oauth2':
          if (auth.accessToken || userAuth.accessToken) {
            request.set({ Authorization: `Bearer ${auth.accessToken}` || userAuth.accessToken });
          }
