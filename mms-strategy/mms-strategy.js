...
//   throw new errors.DatabaseError('DB: MMS-Strategy does not support DB Clear', 'critical');
// }
//
// /**
...
//             case 'Object': object[k].type = Object; break;
...
//     if (M.config.db.seedList) {
//       this.baseUrl = M.config.db.seedList[0];
//     }
//     else {
//       this.baseUrl = M.config.db.host + (M.config.db.port) ? ':' + M.config.db.port : '';
//     }
//
//     this.apiClient = new ApiClient(this.baseUrl,{'bearerToken' : {type: 'oauth2'}})
//     this.helper =  new helpers[collection](apiClient)
