...
async function createArtifact() {
  ...
  try {
    const createdArtifact = await ArtifactController.create(
      adminUser,
      orgID,
      projectID,
      branchID,
...
async function getArtifact() {
  ...
  try {
    ...
    const foundArtifact = await ArtifactController.find(
      adminUser,
      orgID,
      projectID,
      branchID,
...
async function updateArtifact() {
  ...
  try {
    const updatedArtifact = await ArtifactController.update(
      adminUser,
      orgID,
      projectID,
      branchID,
...
async function deleteArtifact() {
  ...
  try {
    // Delete the artifact
    const deletedArtifact = await ArtifactController.remove(
      adminUser,
      orgID,
      projectID,
      branchID,
...
async function deleteArtifacts() {
  ...
  try {
    // Delete the artifact
    const deletedArtifacts = await ArtifactController.remove(
      adminUser,
      orgID,
      projectID,
      branchID,
...
async function postBlob() {
  ...
  try {
    const createdBlob = await ArtifactController.postBlob(
      adminUser,
      orgID,
      projectID,
      artData,
...
async function listBlobs() {
  try {
    ...
    const blobList = await ArtifactController.listBlobs(
      adminUser,
      orgID,
      projectID,
    );
